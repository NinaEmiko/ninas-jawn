        ...
        <section className='app-tab'>
            ...
            <a href="https://github.com/NinaEmiko/code-jawn" target="_blank" rel="noopener noreferrer" className='external-link' data-testid="code-jawn-repo-link">
                ...
                <p data-testid="code-jawn-text1">
                    Code Jawn is a duo-like app with a React frontend and a Spring Boot backend, deployed through Railway.
                ...
                <p data-testid="code-jawn-text2">
                    ...
                    <ul data-testid="code-jawn-list1">
                        {!usernameIsVisible ?
                            <li>Username: <button onClick={() => toggleUsernameVisibility()}>Show</button></li>
                            :
                            <li>Username: SampleAccount</li>
                        }
                        {!passwordIsVisible ?
                            <li>Password: <button onClick={() => togglePasswordVisibility()}>Show</button></li>
                            :
                            <li>Password: Password1!</li>
                        }
                        <h5>*Account settings are disabled for this account.*</h5>
                    </ul>
